...
-- Dumping data for table gpnapo.category_item: ~33 rows (approximately)
/*!40000 ALTER TABLE `category_item` DISABLE KEYS */;
REPLACE INTO `category_item` (`id`, `item_id`, `category_id`) VALUES
	(1, 1, 1),
	(2, 2, 3),
	(3, 3, 1),
	(4, 4, 1),
...
REPLACE INTO `t_items` (`id`, `users_id`, `item_name`, `item_brand`, `item_qty`, `item_short_description`, `item_description`, `slug`, `img_dir`, `archived`, `created_at`, `updated_at`) VALUES
