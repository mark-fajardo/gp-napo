                                ...
                                <div class="shop-single-product">
                                    <div class="shop-single-product__thumb-wrapper">
                                        <div class="shop-single-product__image">
                                            <a href="{{ route('front.item', ['slug' => $item->slug]) }}" class="single-img-wrapper" style="height: 550px !important; width: 550px !important">
                                                <img src="{{ asset($item->img_dir[0]) }}" alt="{{$item->item_name}} image">
                                            </a>
                                        </div>
                                    </div>
