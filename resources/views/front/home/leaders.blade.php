<div class="cta-area cta-area-bg cta-area-bg--style2 section-space--inner--120 bg-img" data-bg="{{asset('assets/img/backgrounds/15-bg2.jpg')}}" style="background-position: center">
  <div class="container">
      <div class="row">
